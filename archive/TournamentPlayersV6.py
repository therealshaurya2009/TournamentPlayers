...
age_options = age_groups_level(tournament_link)
...
sort = scrape_draw_size(tournament_link.replace("overview", "events"), age_group)
scrape_tournament_data(tournament_link.lower(), age_group, sort[0], sort[1], age_options[0])
